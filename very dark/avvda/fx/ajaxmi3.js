...
/////////////////////////////////////////////////////////////////
var idani = ['']; //tableau stockant les ids
var nbid = 0;  //longueur de basse du tableau
var nbidmax = 19; //longueur max du tableaux
...
for (i = 0; i <= idani.length ; i++) {
if (idani[i] == document.getElementById(id))
	{
	if(idani[i].style.visibility == 'hidden'){idani[i].style.display = 'none'}
	if(idani[i].style.visibility == 'visible'){idani[i].style.display = 'block'}
	if(idani[i].style.display == 'none'){idani[i].style.visibility = 'hidden'}
	if(idani[i].style.display == 'block'){idani[i].style.visibility = 'visible'}	
		
		}
}
nbid = Math.round(idani.length + 1);
if (nbid > nbidmax){nbid = 0};	
idani[nbid] = document.getElementById(id);

// type est egal au nom de l'animation/transition deans fx.css
var idaniT = idani[nbid];
...
function andbefore(){
if(idaniT.style.visibility == 'hidden'){idaniT.style.display = 'none'}
if(idaniT.style.visibility == 'visible'){idaniT.style.display = 'block'}
if(idaniT.style.display == 'none'){idaniT.style.visibility = 'hidden'}
if(idaniT.style.display == 'block'){idaniT.style.visibility = 'visible'}
}
function andafter(){
...
{
document.getElementById(div).innerHTML = eval(txt);
	if (scpt == 'on'){
